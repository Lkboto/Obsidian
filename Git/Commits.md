...
Se pueden utilizar paginas como github para ver el codigo y tener lo en una nuve de forma grtuita, github se puede utilizar con git de forma automatica y asi hacer los commits ahí.

Aqui hay algunos [[GitHubHacks]]
...
- Si se debería de empezar con mayúsculas o minúsculas
- La estructura que va a seguir el mensaje 
ditor→Elimina la configuracion en global con la parte del comando que dice --unset.